			...
			<div class="card-header">
				...
				<div class="card-header-action">
					<div class="input-group-btn" id="">
						<a name="" id="btn-tambah-pegawai" class="btn btn-primary" href="#form-tambah-pegawai" role="button"><i class="fas fa-plus"></i> Tambah Pegawai</a>
					</div>
				</div>
			</div>
			<div class="card-body">
				<div class="table-reponsive">
					<table class="table table-sm table-striped" id="pengguna-pegawai-table" style="width: 100%;">
						<thead>
...
<section id="form-tambah-pegawai" style="display: none;">
	<div class="row">
		<div class="col">
			<div class="card">
				<div class="card-header">
					...
					<div class="card-header-action">
						<div class="input-group-btn" id="">
							<a name="" id="tutup-tambah-pegawai" class="btn btn-danger" href="#" role="button"><i class="fas fa-times"></i> Tutup</a>
						</div>
					</div>
				</div>
				<div class="card-body">
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<input type="number" class="form-control" name="nipPegawai" id="nipPegawai" placeholder="Masukkan NIP / Nomor Pegawai">
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col">
										<div class="form-group">
											<div class="row">
												...
												<div class="col-lg-9 col-sm-12">
													<select data-width="100%" class="form-control select2 has-error select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="gradePegawai" id="gradePegawai">
											...
											<div id="form-foto-ktp">
												<div class="form-group mb-1">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="input-foto-ktp" name="input_foto_ktp" accept=".png, .jpg, .jpeg">
									...
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<div id="form-foto-ktp">
												<div class="form-group mb-1">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="input-foto-kk" name="input-foto-kk" accept=".png, .jpg, .jpeg">
									...
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<div id="form-foto-ktp">
												<div class="form-group mb-1">
													<div class="custom-file">
														<input type="file" class="custom-file-input" id="input-foto-slip-gaji" name="input-foto-slip-gaji" accept=".png, .jpg, .jpeg">
														<label class="custom-file-label" for="customFile">Pilih file foto</label>
													</div>
												</div>
												<div class="ml-1">
						...
						<div class="row">
							<div class="col">
								<div class="float-right">
									<button name="" id="btn-tambah-data-pegawai" class="btn btn-sm btn-primary btn-tambah-data-pegawai" href="#" role="button"><i class="fas fa-plus"></i> Tambah Data</button>
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<input type="text" class="form-control " id="nipPegawai2" value="" disabled>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<select data-width="100%" class="form-control  select2" aria-hidden="true" id="gradePegawai2" disabled>
											</select>
											<!-- <input type="text" class="form-control " id="gradePegawai2" value="" disabled> -->
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<div id="ktp-pegawai">
												<a href="" id="img-ktp-show" target="_blank">
													<img src="" id="img-ktp" alt="" style="width: 95%; margin-top: 20px;">
												</a>
											</div>
											<div id="inputfoto-ktp" style="display: none;">
												<div class="form-group mb-1">
													<input type="file" id="foto-ktp2" name="input-foto" class="form-control" accept=".png, .jpg, .jpeg">
												</div>
												<div class="ml-1">
													<small>* Ukuran file maksimal 2MB.</small>
												</div>
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<div id="kk-pegawai">
												<a href="" id="img-kk-show" target="_blank">
													<img src="" id="img-kk" alt="" style="width: 95%; margin-top: 20px;">
												</a>
											</div>
											<div id="inputfoto-kk" style="display:none">
												<div class="form-group mb-1">
													<input type="file" id="foto-kk2" name="input-foto" class="form-control" accept=".png, .jpg, .jpeg">
												</div>
												<div class="ml-1">
													<small>* Ukuran file maksimal 2MB.</small>
												</div>
							...
							<div class="col-lg-6 col-sm-12">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-9 col-sm-12">
											<div id="slip-pegawai">
												<a href="" id="img-slip-show" target="_blank">
													<img src="" id="img-slip" alt="" style="width: 95%; margin-top: 20px;">
												</a>
											</div>
											<div id="inputfoto-slip" style="display:none">
												<div class="form-group mb-1">
													<input type="file" id="foto-slip2" name="input-foto" class="form-control" accept=".png, .jpg, .jpeg">
												</div>
												<div class="ml-1">
													<small>* Ukuran file maksimal 2MB.</small>
												</div>
						...
						<div class="row">
							<div class="col">
								<div class="float-right" id="btn-ubah-data-pegawai2">
									...
									<button name="" id="btn-ubah-slip" class="btn btn-sm btn-primary btn-ubahFoto" href="#" role="button"><i class="fas fa-image"></i> Ubah Foto Slip Gaji</button>
									...
									<button name="" id="btn-ubah-data-pegawai" class="btn btn-sm btn-warning btn-ubahFoto"role="button" onclick="btnCetakKartu()"><i class="fas fa-print"></i> Cetak Kartu Anggota</button>
								</div>
...
<form action="<?= base_url('cetak-kartu-anggota') ?>" target="_blank" method="POST" id="cetakKartuAnggota" hidden>
	<input type="text" value="<?= $this->session->userdata('id') ?>" name="id" id="idCetakPegawai">
</form>
...
<script>
	...
	function btnCetakKartu(){
		$('#cetakKartuAnggota').submit();
	}

	function dataPegawai() {
		$.ajax({
			type: 'get',
			url: `<?= base_url('pengguna-pegawai-data') ?>`,
			dataType: 'json',
			success: function(response) {
				$('#pengguna-pegawai-table').DataTable({
					processing: true,
					data: response,
	...
	$('#nipPegawai').keydown(function() {
		$('#nipPegawai').removeClass('is-invalid')
	})
	...
	$('#input-foto-ktp').change(function() {
		$('#input-foto-ktp').removeClass('is-invalid')
	})

	$('#input-foto-kk').change(function() {
		$('#input-foto-kk').removeClass('is-invalid')
	})

	$('#input-foto-slip-gaji').change(function() {
		$('#input-foto-slip-gaji').removeClass('is-invalid')
	})
	...
	$('#btn-tambah-pegawai').click(function() {
		$('#form-tambah-pegawai').show()
		$('#btn-tambah-pegawai').hide()
	})

	$('#tutup-tambah-pegawai').click(function() {
		$('#form-tambah-pegawai').hide()
		$('#btn-tambah-pegawai').show()
	})



	$('#btn-tambah-data-pegawai').click(function(e) {
		e.preventDefault()

		var foto_ktp = $('#input-foto-ktp').val()
		var foto_kk = $('#input-foto-kk').val()
		var foto_slip_gaji = $('#input-foto-slip-gaji').val()
		...
		} else if ($('#nipPegawai').val() == '') {
			Swal.fire(
				'NIP / Nomor Pegawai wajib diisi',
				'',
				'error'
			).then(function() {
				$('#nipPegawai').addClass('is-invalid')
			})
		} else if ($('#gradePegawai').val() == '') {
			Swal.fire(
				'Grade wajib diisi',
				'',
				'error'
			).then(function() {
				$('#gradePegawai').addClass('has-error')
			})
		...
		} else if ($('#input-foto-ktp').val() == '') {
			Swal.fire(
				'Foto KTP wajib diisi',
				'',
				'error'
			).then(function() {
				$('#input-foto-ktp').addClass('is-invalid')
			})
		} else if ($('#input-foto-kk').val() == '') {
			Swal.fire(
				'Foto KK wajib diisi',
				'',
				'error'
			).then(function() {
				$('#input-foto-kk').addClass('is-invalid')
			})
		} else if ($('#input-foto-slip-gaji').val() == '') {
			Swal.fire(
				'Foto Slip Gaji wajib diisi',
				'',
				'error'
			).then(function() {
				$('#input-foto-slip-gaji').addClass('is-invalid')
			})
		}
		// else if ($('#input-foto-profil').val() == '') {
		// 	Swal.fire(
		// 		'Foto Profil wajib diisi',
		// 		'',
		// 		'error'
		// 	).then(function() {
		// 		$('#input-foto-profil').addClass('is-invalid')
		// 	})
		// } 
		else {
			...
			$.ajax({
				...
				success: function(response) {
					if (response.res == 'nama') {
						...
						Swal.fire({
							title: 'Apakah anda yakin ingin menambahkan data pegawai ?',
							icon: 'question',
							...
							if (result.isConfirmed) {
								...
								fd.append('grade', $('#gradePegawai').val())
								fd.append('username', $('#usernamePegawai').val())
								fd.append('password', $('#passwordPegawai').val())
								fd.append('foto_ktp', $('#input-foto-ktp')[0].files[0])
								fd.append('foto_kk', $('#input-foto-kk')[0].files[0])
								fd.append('foto_slip_gaji', $('#input-foto-slip-gaji')[0].files[0])
								fd.append('foto_profil', $('#input-foto-profil')[0].files[0])
								$.ajax({
									type: 'post',
									url: `<?= base_url('tambah-data-pegawai') ?>`,
									data: fd,
									processData: false,
									contentType: false,
									dataType: 'json',
	...
	function detailPegawai(id) {
		$.ajax({
			...
			success: function(data) {
				...
				setTimeout(function() {
					$("#img-ktp").attr("src", "./uploads/img/" + data.foto_ktp).trigger('change');
					$("#img-kk").attr("src", "./uploads/img/" + data.foto_kk).trigger('change');
					$("#img-slip").attr("src", "./uploads/img/" + data.foto_slip_gaji).trigger('change');
					$("#img-profil").attr("src", "./uploads/img/" + data.foto_profil).trigger('change');
				}, 800);
				$("#img-ktp-show").attr("href", "./uploads/img/" + data.foto_ktp)
				$("#img-kk-show").attr("href", "./uploads/img/" + data.foto_kk)
				$("#img-slip-show").attr("href", "./uploads/img/" + data.foto_slip_gaji)
				...
				$.ajax({
					...
					success: function(response) {
						if (response.res == 'success') {
							...
							$('#status-akun-aktif').hide()
							detailPegawai(id)
							$('#pengguna-pegawai-table').DataTable().destroy()
							dataPegawai()
						} else {
							Swal.fire({
								icon: 'error',
	...
	$('#btn-ubah-ktp').click(function() {
		...
		$('.foto-ubah-id').val(id)
		$('.title-modal-foto').text('Ubah Foto KTP')
		$('.btn-perbarui-title').text('Perbarui Foto KTP')
		$('.btn-perbarui-foto').attr('id', 'perbarui-foto-ktp')
		$('.input-foto2').attr('id', 'input-foto-ktp2')

	})

	$(document).on('click', '#perbarui-foto-ktp', function(e) {
		var id = $('#idPegawai2').val()
		Swal.fire({
			title: 'Apakah anda yakin ingin mengubah foto KTP ?',
			icon: 'question',
			showCancelButton: true,
			confirmButtonColor: '#3085d6',
			cancelButtonColor: '#d33',
			...
			if (result.isConfirmed) {
				...
				fd.append('foto_ktp', $('#input-foto-ktp2')[0].files[0])
				$.ajax({
					type: 'post',
					url: `<?= base_url('ubah-foto-ktp') ?>`,
					data: fd,
					processData: false,
					contentType: false,
					dataType: 'json',
	...
	$('#btn-ubah-kk').click(function() {
		var id = $('#idPegawai2').val();
		$('#modal-detail-pegawai').modal('hide')
		$('#modal-ubah-foto').appendTo("body")
		$('#modal-ubah-foto').modal('show')
		$('.foto-ubah-id').val(id)
		$('.title-modal-foto').text('Ubah Foto KK')
		$('.btn-perbarui-title').text('Perbarui Foto KK')
		$('.btn-perbarui-foto').attr('id', 'perbarui-foto-KK')
		$('.input-foto2').attr('id', 'input-foto-kk2')
	})

	$(document).on('click', '#perbarui-foto-KK', function(e) {
		var id = $('#idPegawai2').val()
		Swal.fire({
			title: 'Apakah anda yakin ingin mengubah foto KK ?',
			icon: 'question',
			showCancelButton: true,
			confirmButtonColor: '#3085d6',
			cancelButtonColor: '#d33',
			...
			if (result.isConfirmed) {
				...
				fd.append('id', $('#idPegawai2').val())
				fd.append('nama', $('#namaPegawai2').val())
				fd.append('foto_kk', $('#input-foto-kk2')[0].files[0])
				$.ajax({
					type: 'post',
					url: `<?= base_url('ubah-foto-kk') ?>`,
					data: fd,
					processData: false,
					contentType: false,
					dataType: 'json',
	...
	$('#btn-ubah-slip').click(function() {
		var id = $('#idPegawai2').val();
		$('#modal-detail-pegawai').modal('hide')
		$('#modal-ubah-foto').appendTo("body")
		$('#modal-ubah-foto').modal('show')
		$('.foto-ubah-id').val(id)
		$('.title-modal-foto').text('Ubah Foto Slip Gaji')
		$('.btn-perbarui-title').text('Perbarui Foto Slip Gaji')
		$('.btn-perbarui-foto').attr('id', 'perbarui-foto-slip')
		$('.input-foto2').attr('id', 'input-foto-slip2')
	})

	$(document).on('click', '#perbarui-foto-slip', function(e) {
		var id = $('#idPegawai2').val()

		Swal.fire({
			title: 'Apakah anda yakin ingin mengubah foto slip gaji ?',
			icon: 'question',
			showCancelButton: true,
			confirmButtonColor: '#3085d6',
			cancelButtonColor: '#d33',
			...
			if (result.isConfirmed) {
				...
				fd.append('id', $('#idPegawai2').val())
				fd.append('nama', $('#namaPegawai2').val())
				fd.append('foto_slip_gaji', $('#input-foto-slip2')[0].files[0])
				$.ajax({
					type: 'post',
					url: `<?= base_url('ubah-foto-slip') ?>`,
					data: fd,
					processData: false,
					contentType: false,
					dataType: 'json',
	...
	$('.btn-perbarui-pegawai').click(function() {
		...
		$.ajax({
			type: 'post',
			url: `<?= base_url('cek-data-pegawai-detail') ?>`,
			data: {
				id: id,
				nama: nama,
				username: username,
				...
				if (response.res == 'nama') {
					...
					Swal.fire({
						...
						if (result.isConfirmed) {
							...
							$.ajax({
								type: 'post',
								url: `<?= base_url('ubah-data-pegawai') ?>`,
								data: fd,
								processData: false,
								contentType: false,
								dataType: 'json',
